...
| Case | Art. | Singular | Art. | Plural |
| --- | --- | --- | --- | --- |
| N | ο | **ούθι** | οι |  **ουθίουνε** |
| A | το | **ούθι** | τουρ | **ουθίουνε** |
| G | του | **ούθι** | ? | **?** |
...
**General notes**:
* Articles receive an extra letter if the noun starts with a vowel:
...
| Case | Art. | Singular | Art. | Plural |
| --- | --- | --- | --- | --- |
| N | α | **-α** | οι |  **-ε / -λε / -άε / -άδε** |
| A | τα | **-α** | του | **-ε / -λε / -άε / -άδε** |
| G | τα | **-α** | ? | **?** |

**Notes**:
* Plurals in -άε have singulars in -ά (`check!`).
...
| Case | Art. | Singular | Art. | Plural |
| --- | --- | --- | --- | --- |
| N | α | **άμπελε** | οι |  **αμπέλε** |
| A | ταν | **άμπελε** | τουρ | **αμπέλε** |
| G | ταρ | **άμπελε / αμπελλή** | ? | **?** |
